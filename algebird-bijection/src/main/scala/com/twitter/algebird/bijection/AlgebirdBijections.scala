...
class BijectedMonoid[T, U](
    implicit val monoid: Monoid[T],
    bij: ImplicitBijection[T, U]
...
class BijectedGroup[T, U](
    implicit val group: Group[T],
    bij: ImplicitBijection[T, U]
...
trait AlgebirdBijections {
  ...
  implicit def monoidBijection[T, U](
      implicit bij: ImplicitBijection[T, U]
  ...
  implicit def groupBijection[T, U](
      implicit bij: ImplicitBijection[T, U]
  ...
  implicit def ringBijection[T, U](
      implicit bij: ImplicitBijection[T, U]
  ...
  implicit def fieldBijection[T, U](
      implicit bij: ImplicitBijection[T, U]
