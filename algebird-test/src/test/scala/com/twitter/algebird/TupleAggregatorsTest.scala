...
class TupleAggregatorsTest extends WordSpec with Matchers {
  ...
  "MultiAggregator" should {
    ...
    "Create a MonoidAggregator from a tuple of 5 MonoidAggregators" in {
      val agg: MonoidAggregator[
        Long,
        Tuple5[Long, Long, Long, Long, Long],
        Tuple5[Long, Long, Long, Long, Long]
  ...
  "MapAggregator" should {
    ...
    "Create an aggregator from 6 (key, aggregator) pairs" in {
      val agg: Aggregator[
        Int,
        Tuple6[Long, Int, Int, Int, Int, Int],
        Map[String, Long]
      ] = MapAggregator(
        ("key1", SizeAgg),
        ("key2", MinLongAgg),
    ...
    "Create an aggregator from 7 (key, aggregator) pairs" in {
      val agg: Aggregator[
        Int,
        Tuple7[Long, Int, Int, Int, Int, Int, Int],
        Map[String, Long]
      ] = MapAggregator(
        ("key1", SizeAgg),
        ("key2", MinLongAgg),
    ...
    "Create an aggregator from 8 (key, aggregator) pairs" in {
      val agg: Aggregator[
        Int,
        Tuple8[Long, Int, Int, Int, Int, Int, Int, Int],
        Map[String, Long]
      ] = MapAggregator(
        ("key1", SizeAgg),
        ("key2", MinLongAgg),
    ...
    "Create an aggregator from 9 (key, aggregator) pairs" in {
      val agg: Aggregator[
        Int,
        Tuple9[Long, Int, Int, Int, Int, Int, Int, Int, Int],
        Map[String, Long]
      ] = MapAggregator(
        ("key1", SizeAgg),
        ("key2", MinLongAgg),
    ...
    "Create an aggregator from 10 (key, aggregator) pairs" in {
      val agg: Aggregator[
        Int,
        Tuple10[Long, Int, Int, Int, Int, Int, Int, Int, Int, Int],
        Map[String, Long]
      ] = MapAggregator(
        ("key1", SizeAgg),
        ("key2", MinLongAgg),
