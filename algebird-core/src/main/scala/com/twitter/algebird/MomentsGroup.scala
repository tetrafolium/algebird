...
/** A class to calculate the first five central moments over a sequence of
  * Doubles. Given the first five central moments, we can then calculate metrics
...
object Moments {
  ...
  def numericAggregator[N](implicit
      num: Numeric[N]
