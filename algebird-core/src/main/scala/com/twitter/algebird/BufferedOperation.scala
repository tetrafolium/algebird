...
/** Represents something that consumes I and may emit O. Has some internal state
  * that may be used to improve performance. Generally used to model folds or
  * reduces (see BufferedReduce)
  */
...
/** This never emits on put, you must call flush designed to be use in the
  * stackable pattern with ArrayBufferedOperation
  */
