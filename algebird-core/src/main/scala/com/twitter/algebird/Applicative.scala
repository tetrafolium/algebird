...
/** Group, Ring, and Field ARE NOT AUTOMATIC. You have to check that the laws
  * hold for your Applicative. If your M[_] is a wrapper type (Option[_],
  * Some[_], Try[_], Future[_], etc...) this generally works.
  */
