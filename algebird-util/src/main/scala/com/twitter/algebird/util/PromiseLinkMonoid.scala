...
/** This Monoid allows code to depend on the result of computation
  * asynchronously. This is a slightly less general version of the TunnelMonoid.
  * See the documentation for TunnelMonoid for general motivation. NOTE: the
  * Promise will be fulfilled with the value just before the PromiseLink is
  * calculated.
  */
...
/** This class allows code to depends on the data that a value will be combined
  * with, fulfilling the Promise with the value just before the value is added
  * in.
  */
...
object PromiseLink {
  ...
  implicit def monoid[V](implicit
      innerMonoid: Monoid[V]
  ): PromiseLinkMonoid[V] =
