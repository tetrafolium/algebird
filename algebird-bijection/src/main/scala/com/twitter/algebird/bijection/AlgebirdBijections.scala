...
class BijectedSemigroup[T, U](implicit
    val sg: Semigroup[T],
...
class BijectedMonoid[T, U](implicit
    val monoid: Monoid[T],
    bij: ImplicitBijection[T, U]
...
class BijectedGroup[T, U](implicit
    val group: Group[T],
    bij: ImplicitBijection[T, U]
...
class BijectedRing[T, U](implicit
    val ring: Ring[T],
    bij: ImplicitBijection[T, U]
...
class BijectedField[T, U](implicit
    val field: Field[T],
    bij: ImplicitBijection[T, U]
) extends BijectedRing[T, U]
    with Field[U] {
...
trait AlgebirdBijections {
  ...
  implicit def monoidBijection[T, U](implicit
      bij: ImplicitBijection[T, U]
  ...
  implicit def groupBijection[T, U](implicit
      bij: ImplicitBijection[T, U]
  ...
  implicit def ringBijection[T, U](implicit
      bij: ImplicitBijection[T, U]
  ...
  implicit def fieldBijection[T, U](implicit
      bij: ImplicitBijection[T, U]
  ): Bijection[Field[T], Field[U]] =
    new AbstractBijection[Field[T], Field[U]] {
      override def apply(field: Field[T]) =
        new BijectedField[T, U]()(field, bij)
      override def invert(field: Field[U]) =
        new BijectedField[U, T]()(field, Reverse(bij.bijection))
    }
}
