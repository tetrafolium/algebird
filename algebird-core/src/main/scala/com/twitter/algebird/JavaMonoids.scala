...
/** Since Lists are mutable, this always makes a full copy. Prefer scala
  * immutable Lists if you use scala immutable lists, the tail of the result of
  * plus is always the right argument
  */
...
/** Since maps are mutable, this always makes a full copy. Prefer scala
  * immutable maps if you use scala immutable maps, this operation is much
  * faster TODO extend this to Group, Ring
  */
