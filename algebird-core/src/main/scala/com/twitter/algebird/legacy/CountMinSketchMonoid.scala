...
/** Creates instances of type `CountMinSketchMonoid` (which is a type alias for
  * the legacy class of the same name in Algebird versions < 0.8.1).
  *
  * =Deprecated since 0.8.1=
  *
  * Only use this object when transitioning legacy code. Newer code should use
  * [[TopPctCMS.monoid()]]:
  *
  * {{{
